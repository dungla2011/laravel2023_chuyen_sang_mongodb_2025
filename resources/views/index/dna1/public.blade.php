...
@section('content')
    ...
    <style>
        ...
        #icon-bot{
            /*làm cho có shadown*/
            box-shadow: 10px 10px 20px rgba(0, 0, 0, 0.3); /* Tạo đổ bóng */

        }
    </style>

    <section class="wrapper bg-gradient-primary qqqq1111" data-code-pos='ppp17372708764011'>

        <?php

        $ui = \App\Models\BlockUi::showEditButtonStatic('banner-top');
        $mText = explode("\n", $ui->getExtra());
        ...
        <div class="container pt-10 pt-md-14 pb-8 text-center">
            <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                <div class="col-lg-7">
                    <figure><img class="w-auto" src="{{$img ?? '/template/sandbo/assets/img/concept/concept2.png'}}"
                                 srcset="{{$img ?? '/template/sandbo/assets/img/concept/concept2.png'}} 2x" alt="" /></figure>
                </div>
                <!-- /column -->
                <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-5 text-center text-lg-start" data-code-pos='ppp17365784467911'>
                    <h1 class="display-1 mb-5 mx-md-n5 mx-lg-0" style="font-size: 180%">
                        {{$mText[0] ?? 'not set'}}
                        </h1>
                    <p class="lead fs-lg mb-7">
                        {{$mText[1] ?? 'not set'}}
                    </p>
                    <span><a id="traiNghiemNgay" class="btn btn-primary rounded-pill me-2" href="{{$mText[3] ?? 'not set'}}">
                            {{$mText[2] ?? 'not set'}}
                        </a></span>
                </div>
                <!-- /column -->
    ...
    <!-- /section -->
    <section class="wrapper bg-light" data-code-pos='ppp17372708725951'>
        <div class="container pt-6 pt-md-6 qqqq1111">
            <?php
            $ui = \App\Models\BlockUi::showEditButtonStatic('tinh-nang');

            $mText = explode("\n", $ui->getExtra());

            //là mảng text, bỏ đi các dòng rỗng, va index lai mang
            $mText = array_values(array_filter($mText, function ($value) {
                return $value !== '';
            }));

            ?>
            <div class="row text-center">
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2" data-code-pos='ppp17364720253841'>
...
{{--                    <h3 class="display-4 mb-10 px-xl-10">The service we offer is specifically designed to meet your needs.</h3>--}}
                    <h3 class="display-4 mb-10 px-xl-10">{{$ui->name ?? 'not set name'}}</h3>

                </div>
                <!-- /column -->
            </div>
            <!-- /.row -->
            <div class="position-relative" data-code-pos='ppp17372708695701'>
                ...
                <div class="row gx-md-5 gy-5 ">
                    <div class="col-md-6 col-xl-3">
                        <div class="card flex-grow-1 shadow-lg tinh-nang">
                            <div class="card-body">
                                ...
                                <h4>{{$mText[0] ?? ''}}</h4>
                                <p class="mb-2">
                                    <i class="uil uil-check fs-21"></i><span>
                                        {{$mText[1] ?? ''}}
                                    </span></li>
                                </p>
                                <p class="mb-2">
                    ...
                    <!--/column -->
                    <div class="col-md-6 col-xl-3" data-code-pos='ppp17372708667951'>
                        <div class="card flex-grow-1  shadow-lg tinh-nang">
                            <div class="card-body">
                    ...
                    <!--/column -->
                    <div class="col-md-6 col-xl-3" data-code-pos='ppp17372708600581'>
                        <div class="card flex-grow-1  shadow-lg  tinh-nang">
                            <div class="card-body">
                    ...
                    <!--/column -->
                    <div class="col-md-6 col-xl-3" data-code-pos='ppp17372708630901'>
                        <div class="card flex-grow-1  shadow-lg  tinh-nang">
                            <div class="card-body">
    ...
    <section
        data-code-pos='ppp17372708551251'
        class="wrapper image-wrapper bg-image bg-overlay qqqq1111"
             data-image-src="/template/sandbo/assets/img/server-background5.png"
             style="background-image: url('/template/sandbo/assets/img/server-background5.png');">
        <div class="container py-10 py-md-12 white-all-text mt-10" style="">

            <?php
            $ui = \App\Models\BlockUi::showEditButtonStatic('giữa-trang-chủ');
            $mText = explode("\n", $ui->getExtra());
            $mText = array_values(array_filter($mText, function ($value) {
                return $value !== '';
            }));
            ...
            <div class="row qqqq1111" data-code-pos='ppp17372708492231'>
                <div class="col-xl-10 mx-auto">
                    <div class="row align-items-center counter-wrapper gy-6 text-center">
                        <div class="col-md-3">
                            ...
                            <h3 class="counter" style="visibility: visible;">{{$mText[0] ?? ''}}</h3>
                            <p>{{$mText[1] ?? ''}}</p>
                        </div>
                        <!--/column -->
                        <div class="col-md-3">
                            ...
                            <h3 class="counter" style="visibility: visible;">{{$mText[2] ?? ''}}</h3>
                            <p>{{$mText[3] ?? ''}}</p>
                        </div>
                        <!--/column -->
                        <div class="col-md-3">
                            ...
                            <h3 class="counter" style="visibility: visible;">{{$mText[4] ?? ''}}</h3>
                            <p>{{$mText[5] ?? ''}}</p>
                        </div>
                        <!--/column -->
                        <div class="col-md-3">
                            ...
                            <h3 class="counter" style="visibility: visible;">{{$mText[6] ?? ''}}</h3>
                            <p>{{$mText[7] ?? ''}}</p>
                        </div>
                        <!--/column -->
                    </div>
    ...
    <!-- /section -->
    <section class="wrapper " data-code-pos='ppp17372708418631'>
        <div class="container py-8 pt-md-8 pb-md-12 qqqq1111">
            <?php
            $ui = \App\Models\BlockUi::showEditButtonStatic('our-team');
            $mText = explode("\n", $ui->getExtra());
            ...
            ?>
            <div class="position-relative " data-code-pos='ppp17372708387581'>
                <div class="row text-center">
                    <div class="col-lg-6 mx-auto">
                        <h2 class="fs-16 text-uppercase text-muted mb-3 qqqq1111">

                            <?php
                            $ui = \App\Models\BlockUi::showEditButtonStatic('our-team-name');
                            ?>
                            {{ $ui->name ?? 'not set dname' }}
                ...
                $i = 0;
                ?>
                <div class="position-relative" data-code-pos='ppp17372708354901'>
                    ...
                    <div class="row grid-view gy-6 gy-xl-0">
                        <div class="col-md-6 col-xl-3">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <img class="rounded-circle w-15 mb-4" src="{{$mImg[0] ?? '/template/sandbo/assets/img/avatars/te1@2x.jpg'}}" srcset="{{$mImg[0] ?? '/template/sandbo/assets/img/avatars/te1@2x.jpg'}} 2x" alt="" />
                                    <h4 class="mb-1">{{$mText[$i] ?? 'not set'}}</h4>
                                    <div class="meta mb-2">{{$mText[++$i] ?? 'not set'}}</div>
                                    <p class="mb-2">{{$mText[++$i] ?? 'not set'}}</p>
                        ...
                        <!--/column -->
                        <div class="col-md-6 col-xl-3" data-code-pos='ppp17372708320151'>
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <img class="rounded-circle w-15 mb-4" src="{{$mImg[1] ?? '/template/sandbo/assets/img/avatars/te1@2x.jpg'}}" srcset="{{$mImg[1] ?? '/template/sandbo/assets/img/avatars/te1@2x.jpg'}} 2x" alt="" />
                                    <h4 class="mb-1">{{$mText[++$i] ?? 'not set'}}</h4>
                                    <div class="meta mb-2">{{$mText[++$i] ?? 'not set'}}</div>
                                    <p class="mb-2">{{$mText[++$i] ?? 'not set'}}</p>
                                    <nav class="nav social mb-0">
                        ...
                        <!--/column -->
                        <div class="col-md-6 col-xl-3" data-code-pos='ppp17372708289691'>
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <img class="rounded-circle w-15 mb-4" src="{{$mImg[2] ?? '/template/sandbo/assets/img/avatars/te1@2x.jpg'}}" srcset="{{$mImg[2] ?? '/template/sandbo/assets/img/avatars/te1@2x.jpg'}} 2x" alt="" />
                                    <h4 class="mb-1">{{$mText[++$i] ?? 'not set'}}</h4>
                                    <div class="meta mb-2">{{$mText[++$i] ?? 'not set'}}</div>
                                    <p class="mb-2">{{$mText[++$i] ?? 'not set'}}</p>
                                    <nav class="nav social mb-0">
                        ...
                        <!--/column -->
                        <div class="col-md-6 col-xl-3" data-code-pos='ppp17372708258931'>
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <img class="rounded-circle w-15 mb-4" src="{{$mImg[3] ?? '/template/sandbo/assets/img/avatars/te1@2x.jpg'}}" srcset="{{$mImg[3] ?? '/template/sandbo/assets/img/avatars/te1@2x.jpg'}} 2x" alt="" />
                                    <h4 class="mb-1">{{$mText[++$i] ?? 'not set'}}</h4>
                                    <div class="meta mb-2">{{$mText[++$i] ?? 'not set'}}</div>
                                    <p class="mb-2">{{$mText[++$i] ?? 'not set'}}</p>
                                    <nav class="nav social mb-0">
    ...
    <!-- /section -->
    <section class="wrapper bg-light pb-5 qqqq1111" data-code-pos='ppp17372708214221' >
        <?php
        $ui = \App\Models\BlockUi::showEditButtonStatic('our-solutions');
        $mText = explode("\n", $ui->getExtra());
        $img = $ui->getThumbInImageList();
        ...
        ?>
        <div class="container">
            <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center" data-code-pos='ppp17372708105481'>
                <div class="col-lg-7 order-lg-2">
                    <figure><img class="w-auto" src=" {{ $img ?? '/template/sandbo/assets/img/concept/concept8.png' }} " srcset="{{ $img ?? '/template/sandbo/assets/img/concept/concept8.png' }} 2x" alt="" /></figure>
                </div>
                <?php
                $i = 1;
                ?>
                ...
                <!--/column -->
                <div class="col-lg-5" data-code-pos='ppp17372708040661'>
                    <h2 class="fs-16 text-uppercase text-muted mb-3">{{$ui->name ?? ''}}</h2>
                    ...
                    <div class="row gy-3">
                        <div class="col-xl-6">
                            <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                                <li><span><i class="uil uil-check"></i></span><span>{{$mText[$i++] ?? 'not set1'}}</span></li>
                                <li class="mt-3"><span><i class="uil uil-check"></i></span><span>{{$mText[$i++] ?? 'not set1'}}</span></li>
                            </ul>
                        </div>
                        <!--/column -->
                        <div class="col-xl-6">
    ...
    <section class="wrapper bg-light pb-12 mt-5 qqqq1111" data-code-pos='ppp17372708163901'>
        <?php
        $ui = \App\Models\BlockUi::showEditButtonStatic('our-partner');
        $mImg = $ui->getAllImageList();
    ...
    <script>
        window.addEventListener('DOMContentLoaded', (event) => {
            ...
            document.getElementById('traiNghiemNgay').addEventListener('click', function(){var iconBot = document.getElementById('c-icon-bot'); iconBot.dispatchEvent(new Event('click', {bubbles: true}));})

            //Click vao ID= traiNghiemNgay, thi click vao nut co ID=icon-bot

            document.getElementById('traiNghiemNgay').addEventListener('click', function () {
                //Báo lỗi  đây, hãy sửa:

                document.getElementById('icon-bot')?.click();
