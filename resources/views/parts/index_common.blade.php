...
<section id="show_action_multi_item" style="">
    <div class="sub_multi" style="">
        ...
        if(isDebugIp()){
        ?>
        <button title="Share Files" data-code-pos="qqq170669975" style="background-color: dodgerblue" id="share_files">
            Chia sẻ
        </button>
        <?php
        }
        ...
        if(($mMetaAll['parent_id'] ?? '')) {
            ?>
        <button title="Move to Folder / Category" data-code-pos="qqq1706687999975" style="background-color: dodgerblue" id="move_item_multi">
            Di chuyển
        </button>
            <?php
        }
        ...
        <button data-code-pos="qqq1706688004238" style="background-color: orangered" id="delete_item_multi">Xóa
        </button>


        <button title="get all id list selected" data-code-pos="qqq17066879111" style="background-color: #ccc" id="get_id_list">
            IDList
        </button>


        <button data-code-pos="qqq1706688002245" style="background-color: #ccc" id="update_parent_list">Update Parent
        </button>
        <?php
        }
        ?>
...
//        if(isIPDebug())
        ...
        if($mFieldFS = $objMeta->getFullSearchJoinField())
        {
            ...
            foreach ($mFieldFS AS $fields => $typeJoin){
                ...
                $strDescFieldSearch .= $objMeta->getFullDescField($fields). ", ";
            }
    ...
    <div class="container-fluid table_grid_index mb-2 px-3">
        ...
        <div class="row">
            <div class="pagination_div col-sm-8 filter_9" data-code-pos="ppp1676113887607" style="padding-left: 0px">

                <div style="display: flex; align-items: center; margin-top: 8px">
                <?php

                echo '<select class="select_glx"
            ...
            <div class="col-sm-4  filter_3 mr-0 pr-0" style="" data-code-pos='ppp17323266639701'>
                <?php
                if(!request('in_trash')){
                    ?>
                <div style="z-index: 100000">
                    ...
                    if($objMeta::enableAddMultiItem()){
                        ?>
                    <a title="Tạo nhiều hàng" data-code-pos="ppp1665645645363340" href="<?php
                    ...
                    if(!$objMeta::$disableAddItem && $mEditAbleInGetOne){
                        ?>

                    <a title="Add new item" data-code-pos="ppp1667661363340" id="add-new-item" href="<?php echo $objMeta->getAdminUrlWeb($objPr->module) . "/create" ?>"
                    ...
                    if(!$objMeta::$disableSaveAllButton  && $mEditAbleIndex){
                        ?>

                    <a title="Save All" id="save-all-data"
                       class="btn btn-primary btn-sm float-right mt-2 ml-3">
                    ...
                    <?php
//                        if($objMeta::$modelClass && in_array(\Illuminate\Database\Eloquent\SoftDeletes::class, class_uses($objMeta::$modelClass)))
                        {
