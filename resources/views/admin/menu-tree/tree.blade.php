                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item" data-code-pos='ppp17256351521'><a href="/admin/menu-tree/">Menu Index</a></li>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div style="margin-bottom: 10px">
                    ...
                    <div class="row">
                        <div class="col-sm-2 menu_title"><i class="fa fa-edit"></i> Chọn Nhóm:</div>
                        <div class="col-sm-9">
                            <?php
