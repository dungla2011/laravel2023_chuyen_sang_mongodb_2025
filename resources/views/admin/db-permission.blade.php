...
//                $mTable = \LadLib\Common\Database\DbHelper::getAllTableName($connectionDb, env("DB_DATABASE"));
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        ...
                        echo "</select> ";
                        echo "<br/>\n";
                        echo "<span class='span_api_text'> Model-API : " . $urlApi . " (Class: " . $clsMeta . ") </span>";
                    ...
                    <div class="col-md-6">
                        ...
                        <button style='font-size: smaller; width: ' class='float-right1' id="replace_all_input" > Replace </button>
                                            ...
                                            if ($disabledOK) {
                                                if (is_array($funcMap)) {
                                                    if ($val) {
                                                        ...
                                                        echo "<span data-code-pos='ppp16666147448011' data-join-func='' class='spanField'>" . $funcMap[$val] . "</span>";
                                                    }
                                                }
                                                //echo "ABC";
                                            } else
