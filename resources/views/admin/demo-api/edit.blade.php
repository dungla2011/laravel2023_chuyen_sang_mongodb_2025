                ...
                <div class="row mb-0">
                    <div class="col-sm-10">
                        ...
                        <div class="m-0" data-code-pos="ppp1676081871796" style="font-size: large; display: none">
                            ...
                            <a title="Xem lịch sử thanh đổi Bản ghi này" target="_blank" href="/admin/change-log?seby_s9={{$idx}}&seoby_s8=eq&seby_s8=<?php echo $objData->getTable() ?>">
...
//                $objMeta->extraContentIndex1();
                ...
                <div class="row" data-code-pos='ppp17331995989861'>
                    <div class="col-md-12 menu_action_edit" style="">
                        ...
                        <a title="Xem lịch sử thanh đổi Bản ghi này" class="btn btn-outline-primary  m-2 ctrl_btn" target="_blank" href="/admin/change-log?seby_s9={{$idx}}&seoby_s8=eq&seby_s8=<?php echo $objData->getTable() ?>">
                            <i  class="fa fa-history"></i>
                        </a>
                            <?php
                            }
...
//                                    $objData->id = $dataId;
                                ...
                                if (!$objMeta->isShowGetOne($field, $gid))
                                    continue;
                                $desc = strip_tags($objMeta->getDescOfField($field));
                                $displayInput = '';
                                $extraCss = $readOnly = '';
...
//                                if(!method_exists($objData, $field))
                                if($field[0] == '_')
                                    $valueField = $objMeta->$field($data, null, $field);
                                else
...
//                                    && getCurrentUserEmail() != env("AUTO_SET_ADMIN_EMAIL")
                                ...
                                <div data-field="<?php echo $field ?>" data-code-pos="ppp1665495258724" data-id="<?php echo $dataId ?>"
                                     class="divTable2Row" style="position: relative">
...
?>
                                        ...
                                        <div data-namex2="<?php echo $field ?>" class="data_name_x2">
                                            ...
                                            <div class="mau_copy" style="display: none; position: absolute; top: 1px; right: 1px; z-index: 1000000">
                                                ...
                                                <button type="button" class="btn btn-sm btn-primary btn_copy_temp" data-copy-field="{{$field}}"
                                                        title="Copy giá trị từ mẫu, id = {{$idMau}}"> Copy Mẫu </button>
...
class='sl_option $objMeta->css_class' style='$objMeta->css; max-width: 200px' data-field='$field' >";
...
//                                                                        $joinSpan = "<span data-code-pos='ppp1665496105102' data-autocomplete-id='$dataId-$field' class='span_auto_complete' data-item-value='$valueField' title='Remove this item'>$valJoin [x]</span>";
                                                ...
                                                if ($objData->$field)
                                                    echo "<div data-code-pos='qqq1681816852441' class='status_edit_one'><i data-id='$dataId' data-field='$field' class='fa fa-toggle-on $cls'></i></div>";
                                                else
                                                    echo "<div data-code-pos='qqq1681816852441' class='status_edit_one'><i data-id='$dataId' data-field='$field' class='fa fa-toggle-off $cls'></i></div>";
                                            ...
                                            elseif($objMeta->isTextAreaField($field)){
                                                ...
                                                echo "<textarea data-code-pos='ppp1677658885589' class='for_up_down_key input_value_to_post text_area_edit' $readOnly placeholder='Input $desc' name='$field' title='$fullDes / $field' data-type='text_area' data-field='$field' style='$cssRo' id='edit_text_area_$field'>$valueFieldOK</textarea>";
                                                $isTextArea = 1;
                                            }
...
//                                                    }
    ...
    placeholder='Input $desc ($fullDes)' name='$field' data-field='$field' type='$typeText' value='$valueField'>";
