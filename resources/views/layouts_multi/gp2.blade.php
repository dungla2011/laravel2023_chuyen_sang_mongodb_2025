<?php
    ...
    if(\LadLib\Common\UrlHelper1::getUriFromFullUrl() != '/login'){
...
{{--            <div data-code-pos='ppp16900999250751' class="" style="--}}
{{--            margin: 0 auto; text-align: center; display: flex; justify-content: center; align-items: center; width: 290px; height: 50px; background-image: url('<?php echo $img0 ?>');  background-repeat: no-repeat; background-size: 100% 100%;">--}}
...
{{--    <button data-code-pos='ppp17371659204071' id="auto_search_button" type="submit" value=""><i class="fa fa-search"></i></button>--}}

    <span style="position: absolute; right: 20px; top: 10px">
        <?php
        if($mail = getCurrentUserEmail()){
            echo "<a href='/member'>$mail</a>";
        }else{
...
//        \App\Models\BlockUi::showEditLink_("abc" , 'sửa khối abc');
        ...
        <div class="banner_left" style="" data-code-pos='ppp17248395967701'>
            <div class="rotating lgxoay" style="background: url(<?php echo $img0 ?>);
            background-size: cover;">
            </div>
            <a href="/">
                <div class="logo_xoay_text" style="">
        ...
        <div class="banner_right banner-top"
             style="background-image: url('<?php echo $img1 ?>')">
            <div style="text-align: center" data-code-pos='ppp17326140510991'>
            <?php
            echo $ui->getContent();
            ?>
            </div>
